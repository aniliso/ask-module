...
@section('content-header')
    <h1>
        {{ trans('ask::questions.title.create question') }}
    </h1>
    <ol class="breadcrumb">
        <li><a href="{{ route('dashboard.index') }}"><i class="fa fa-dashboard"></i> {{ trans('core::core.breadcrumb.home') }}</a></li>
        <li><a href="{{ route('admin.ask.question.index') }}">{{ trans('ask::questions.title.questions') }}</a></li>
        <li class="active">{{ trans('ask::questions.title.create question') }}</li>
    </ol>
@stop
...
@section('content')
    {!! Form::open(['route' => ['admin.ask.question.store'], 'method' => 'post']) !!}
    <div class="row">
        <div class="col-md-12">
            <div class="box">
